...
void CCubeView::OnEditSolve()
{
    ...
    // solve centers
    FixTopCenters(count, moves);
    FixBottomCenters(count, moves);
    FixBackCenters(count, moves);
    FixLeftCenters(count, moves);
...
void CCubeView::FixTopCenters(int count, Move* moves)
{
    for (int row = 1; row < (m_Size-1); ++row)
    {
        for (int column = 1; column < (m_Size-1); ++column)
        {
            int type = 0;
            PlayMoves(count, moves);
            if (IsColor(1, m_Size-1-column, row, 0))
            {
                // already on left side correct spot
                continue;
            }
            // one move away
            if (IsColor(2, m_Size-1-column, row, 0))
            {
                type=1;
                // front correct spot
                AddMove(4, m_Size-1-column, count, moves);
            }
            else if (IsColor(5, column, m_Size-1-row, 0))
            {
                type=2;
                // back correct sport
                AddMove(5, column, count, moves);
            }
            // two moves away 
            else if (IsColor(3, m_Size-1-column, row, 0))
            {
                type=3;
                // right correct sport
                AddMove(4, m_Size-1-column, count, moves);
            ...
            else if (IsColor(2, row, column, 0))
            {
                type=4;
                // front rotated 90
            ...
            else if (IsColor(5, m_Size-1-row, m_Size-1-column, 0))
            {
                type=5;
                // back rotated 90
            ...
            else if (IsColor(2, m_Size-1-row, m_Size-1-column, 0))
            {
                type=6;
                // front rotated 270
            ...
            else if (IsColor(5, row, column, 0))
            {
                type=7;
                // back rotated 270
            ...
            // three moves away
            else if (IsColor(3, row, column, 0))
            {
                type=8;
                // right rotated 90
            ...
            else if (IsColor(3, m_Size-1-row, m_Size-1-column, 0))
            {
                type=9;
                // right rotated 270
            ...
            else if (IsColor(2, column, m_Size-1-row, 0))
            {
                type=10;
                // front rotated 180
                AddMove(2, 0, count, moves);
            ...
            else if (IsColor(0, m_Size-1-column, row, 0) && ((m_Size-1-column)>=row))
            {
                type=12;
                // top rotated 90
                AddMove(1, row, count, moves);
                AddMove(4, m_Size-1-column, count, moves);
                AddMove(0, m_Size-1-row, count, moves);
            }
            else if (IsColor(0, column, m_Size-1-row, 0) && (column>=row))
            {
                type=13;
                // top rotated 270
                AddMove(0, row, count, moves);
                AddMove(5, column, count, moves);
                AddMove(1, m_Size-1-row, count, moves);
            }
            else if (IsColor(4, m_Size-1-column, row, 0) && (column>=row))
            {
                type=14;
                // bottom rotated 90 partial
                AddMove(0, m_Size-1-row, count, moves);
                AddMove(4, m_Size-1-column, count, moves);
                AddMove(1, row, count, moves);
            }
            else if (IsColor(4, column, m_Size-1-row, 0) && ((m_Size-1-column)>=row))
            {
                type=15;
                // bottom rotated 270 partial
                AddMove(1, m_Size-1-row, count, moves);
                AddMove(5, column, count, moves);
                AddMove(0, row, count, moves);
            }
            // four moves away
            else if (IsColor(3, column, m_Size-1-row, 0))
            {
                type=16;
                // right rotated 180
                AddMove(0, 0, count, moves);
            ...
            else if (IsColor(0, row, column, 0))
            {
                type=17;
            ...
            else if (IsColor(0, m_Size-1-row, m_Size-1-column, 0) && ((m_Size-1-row)>=row))
            {
                type=18;
                // top rotated 180
                AddMove(4, 0, count, moves);
            ...
            else if (IsColor(4, m_Size-1-column, row, 0))
            {
                type=19;
                // bottom rotated 90 remainder
                AddMove(5, m_Size-1, count, moves);
                AddMove(0, m_Size-1-row, count, moves);
                AddMove(4, m_Size-1-column, count, moves);
                AddMove(4, 0, count, moves);
            }
            else if (IsColor(4, column, m_Size-1-row, 0))
            {
                type=20;
                // bottom rotated 270 remainder
                AddMove(4, 0, count, moves);
                AddMove(1, m_Size-1-row, count, moves);
                AddMove(5, column, count, moves);
                AddMove(5, m_Size-1, count, moves);
            }
            else if (IsColor(1, row, column, 0) && (row != column))
            {
                type=21;
            ...
            else if (IsColor(1, m_Size-1-row, m_Size-1-column, 0) && ((m_Size-1-row) != column))
            {
                type=22;
                AddMove(1, 0, count, moves);
                AddMove(5, column, count, moves);
            ...
            // five moves
            else if (IsColor(4, row, column, 0))
            {
                type=23;
                // bottom correct
                AddMove(5, m_Size-1, count, moves);
            ...
            else if (IsColor(1, column, m_Size-1-row, 0))
            {
                type=25;
                AddMove(1, 0, count, moves);
                AddMove(5, column, count, moves);
        ...
        AddMove(2, m_Size-1-row, count, moves);
    }
}

void CCubeView::FixBottomCenters(int count, Move* moves)
{
}
void CCubeView::FixBackCenters(int count, Move* moves)
{
}
void CCubeView::FixLeftCenters(int count, Move* moves)
{
}
